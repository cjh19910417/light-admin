...
import org.lightadmin.core.config.security.authorization.UrlWithParamSecurityConfig;
...
public class RdbmsFilterInvocationDefinitionSource extends JdbcDaoSupport
		implements FilterInvocationWithPatternMetadataSource {
	...
	/**
	 * 是否为“全允许”的资源，如果在function表里面检索不到相关的配置，可以认为是“全允许”
	 * @param actionPath
	 * @return
